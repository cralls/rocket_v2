...
//        $productIdsStr = false;
    ...
    public function getImage($product, $imageId, $attributes = [])
    {
        ...
        if(isset($image)) $imageInit = $this->_imageHelper->init($product, $imageId, $imageSize)->setImageFile($image->getValue())->getUrl();
        if(isset($imageInit)) $result->setImageUrl($imageInit);
