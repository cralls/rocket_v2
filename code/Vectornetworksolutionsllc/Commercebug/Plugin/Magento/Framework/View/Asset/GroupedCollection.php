...
* All rights reserved
*/
namespace Vectornetworksolutionsllc\Commercebug\Plugin\Magento\Framework\View\Asset;
...
class GroupedCollection
{
    ...
    protected function shouldApplyCommercebug($identifier)
    {
        ...
        $asset_is_commercebug = strpos($identifier, 'Vectornetworksolutionsllc_Commercebug::') !== false;
