...
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function getAllrma()
    {
        ...
        if (!$this->rma) {
            ...
            if (isset($filterData["order_id"]) && $filterData["order_id"] != "") {
            ...
            if (isset($filterData["rma_id"]) && $filterData["rma_id"] != "") {
                $collection->addFieldToFilter("rma_id", $filterData["rma_id"]);
            }
            if (isset($filterData["date"]) && $filterData["date"] != "") {
            ...
            if (isset($filterData["attr"]) && isset($filterData["direction"])
            && $sortingData["attr"] != "" && $sortingData["direction"] != "") {
