...
namespace Webkul\Rmasystem\Mail\Template;
...
/**
 * TransportBuilder contains function for adding attachment
 */
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder
{
    ...
    {
        $this->addAddressByType('cc', $ccAddress, $ccName);
    ...
    protected function prepareMessage()
    {
        ...
        $this->messageData['subject'] = $this->escaper->escapeHtml(
    ...
    public function addAttachment($filepath, $fileName)
    {
        if ($fileName) {
            ...
            $this->setBodyAttachment($this->file->fileGetContents($filepath), $fileName, $fileType);
        }
