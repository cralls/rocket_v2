...
class Save extends \Magento\Backend\App\Action
{
    ...
    protected $uploadModel = \Webkul\Rmasystem\Model\Upload::class;
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getFiles('filename')['error'] == 0) {
            $imageModel = $this->_objectManager->create(\Webkul\Rmasystem\Model\Shippinglabel\Image::class);
        ...
        if ($data) {
            ...
            $this->messageManager->addSuccessMessage(__('test.'));
