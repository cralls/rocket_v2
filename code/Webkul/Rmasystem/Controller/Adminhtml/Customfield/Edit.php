...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Webkul\Rmasystem\Model\CustomfieldFactory $customFieldFactory,
    ...
    public function execute()
    {
        ...
        $model = $this->_customFieldFactory->create();
        if ($id) {
            $model = $this->_customFieldFactory->create()->load($id);
            if (!$model->getId()) {
        ...
        $this->_coreRegistry->register('rmasystem_customfield', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? __('Edit Custom Field') : __('New Custom Field'));
