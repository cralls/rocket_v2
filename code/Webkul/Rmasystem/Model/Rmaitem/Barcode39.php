 ...
 */
namespace Webkul\Rmasystem\Model\Rmaitem;
    ...
    public function draw($filename = null)
    {
        ...
        foreach ($this->_code as $k => $v) {
            ...
            if (isset($this->_codes_39[ord($v)])) {
                ...
                $code = ( $i ? self::BAS2W : null ) . $this->_codes_39[ord($v)];
                ...
                if ($code) {
                    ...
                    for ($j = 0; $j < strlen($code); $j++) {
                        ...
                        if (strlen($f2) == 2) {
                            // set bar fill
                            $fill = $f2 == self::BAF2B || $f2 == self::BASF2B ? "_000" : "_fff";

                            // set bar width
                            $w = $f2 == self::BAF2B || $f2 == self::BAF2W
                             ? $this->barcode_bar_thick : $this->barcode_bar_thin;
