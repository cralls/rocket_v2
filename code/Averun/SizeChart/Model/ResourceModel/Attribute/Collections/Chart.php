...
class Chart extends Collection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(EntityTypeInterface::CHART_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(EntityTypeInterface::CHART_CODE . '_eav_attribute')],
