...
class Edit extends Action
{
    ...
    /** @var chartFactory $objectFactory */
     ...
     * @param ChartFactory $objectFactory
     */
    public function __construct(
        Context $context,
        PageFactory $resultPageFactory,
        Registry $registry,
        ChartFactory $objectFactory
    ) {
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Averun_SizeChart::chart');
        $resultPage->getConfig()->getTitle()->prepend(__('Chart Edit'));
