...
class Category extends Collection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(EntityTypeInterface::CATEGORY_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(EntityTypeInterface::CATEGORY_CODE . '_eav_attribute')],
