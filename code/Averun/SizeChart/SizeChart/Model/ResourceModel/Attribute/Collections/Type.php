...
class Type extends Collection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(EntityTypeInterface::TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(EntityTypeInterface::TYPE_CODE . '_eav_attribute')],
