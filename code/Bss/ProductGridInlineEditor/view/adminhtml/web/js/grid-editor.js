define([
    ...
    $.widget('mage.BssProductGridInlineEditor', {
        ...
        _saveData: function (skus_haschange) {
            var $widget = this, productId, arr_info, status_product, row_setdata, index, filed, value, symbol, symbol_default, salable_quantity, qty;
            ...
            $('.bss-row-edit').each(function () {
                ...
                $(this).find('td').each(function () {
                    if ($(this).hasClass('ids') || $(this).hasClass('bss_attribute_set_id') || !$(this).find('input, select').length) {
                        return true;
                    }
                    index = $(this).index();
