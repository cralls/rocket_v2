...
class Recaptcha extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return \Magento\Framework\App\ObjectManager::getInstance()->get('Bss\SocialLogin\Helper\Data');
    }
    ...
    public function getRecaptchaScript()
    {
        ...
        $language = \Magento\Framework\App\ObjectManager::getInstance()->get('Magento\Framework\Locale\Resolver')->getLocale();
